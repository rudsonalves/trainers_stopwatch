...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      onSecondaryFixed: Color(0xff00184a),
      secondaryFixedDim: Color(0xffb3c5ff),
      onSecondaryFixedVariant: Color(0xff324578),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      secondary: Color(0xff2e4174),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff6073aa),
      ...
      secondaryFixed: Color(0xff6073aa),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff485a8f),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      brightness: Brightness.light,
      primary: Color(0xff071f52),
      surfaceTint: Color(0xff4a5c92),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff2e4074),
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff071f52),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff2e4174),
      onSecondaryContainer: Color(0xffffffff),
      ...
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff152a5d),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff2e4174),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff152a5c),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      onSecondary: Color(0xff192e60),
      secondaryContainer: Color(0xff324578),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      secondary: Color(0xffb9c9ff),
      onSecondary: Color(0xff00133f),
      secondaryContainer: Color(0xff7d8fc8),
      ...
      secondaryFixedDim: Color(0xffb3c5ff),
      onSecondaryFixedVariant: Color(0xff203467),
      tertiaryFixed: Color(0xffffd6f8),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      secondaryContainer: Color(0xffb9c9ff),
      onSecondaryContainer: Color(0xff000000),
      ...
      secondaryFixedDim: Color(0xffb9c9ff),
      onSecondaryFixedVariant: Color(0xff00133f),
